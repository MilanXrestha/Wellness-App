...
class _AddTipScreenState extends State<AddTipScreen> with TickerProviderStateMixin {
  ...
  final TextEditingController _durationInSecondsController = TextEditingController(); // New field
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (args is TipModel) {
        setState(() {
          ...
          _durationInSecondsController.text = args.durationInSeconds?.toString() ?? ''; // New field
          _isShort = args.isShort ?? false; // New field
        });
      }
    });
  }
  ...
  void dispose() {
    ...
    _durationInSecondsController.dispose(); // New field
  ...
  bool _validateForm() {
    ...
    switch (_selectedType) {
      case 'video':
        ...
        if (_durationInSecondsController.text.trim().isNotEmpty) {
          final duration = int.tryParse(_durationInSecondsController.text.trim());
          if (duration == null || duration <= 0) {
            _showError('Duration in seconds must be a positive integer');
            return false;
          }
        }
        break;
  ...
  Future<void> _saveTip() async {
    ...
    try {
      ...
      int? durationInSeconds = int.tryParse(_durationInSecondsController.text.trim()); // New field
      ...
      final tipData = {
        ...
        if (durationInSeconds != null) 'durationInSeconds': durationInSeconds, // New field
        if (_selectedType == 'video') 'isShort': _isShort, // New field
      };
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: selected
                  ...
                  : isDark
                  ? [AppColors.darkSurface, AppColors.darkSurface.withOpacity(0.7)]
  ...
  Widget _buildTipFields() {
    ...
    List<Widget> fields = [
      ...
      if (_selectedType == 'quote' || _selectedType == 'tip' || _selectedType == 'healthTips' || _selectedType == 'video') ...[
        SizedBox(height: 16.h),
        FadeInUp(
          ...
          FadeInUp(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.h),
                TextField(
                  controller: _durationInSecondsController,
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                    hintText: 'Enter duration in seconds (e.g., 30)',
                    filled: true,
                    fillColor: isDark ? AppColors.darkSurface : AppColors.lightSurface,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12.r),
          ...
          FadeInUp(
            ...
            child: Container(
              ...
              child: SwitchListTile(
                ...
                subtitle: Text(
                  'Mark as a short video for Shorts tab',
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    if (_tip == null) {
                                      ...
                                      _durationInSecondsController.clear(); // New field
                                    }
                                  });
                                },
                                decoration: InputDecoration(
          ...
          child: FloatingActionButton.extended(
            ...
            label: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: isDark ? AppColors.shadow : AppColors.shadow.withOpacity(0.15),
                    blurRadius: 8.r,
                    offset: Offset(0, 3.h),
                  ),
                ],
